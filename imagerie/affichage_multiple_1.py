...
for k in range(10):
    ...
    B=np.loadtxt("data/photons_{}.res".format(k))
    ...
    I=np.loadtxt("data/detect_1_I_{}.res".format(k))
    ...
    pola_p=np.loadtxt("data/detect_1_pola_p_{}.res".format(k))
    pola_theta=np.loadtxt("data/detect_1_pola_theta_{}.res".format(k))
    ...
    plt.savefig("data/projection_{:02d}_1.png".format(int(k)),bbox_inches='tight')

os.system("convert -delay 50 -loop 0 data/*_1.png data/projection_log_1.gif ; mpv -loop data/projection_log_1.gif")
#plt.show()
